...
subplot(2,3,1)
hold on
semilogy(mvecs, err_1S./trG, '-', 'Color', colors(1,:), 'LineWidth', 4);
semilogy(mvecs, BestErr_Fro./trG, 'o--', 'Color', colors(1,:), 'LineWidth', 4);
semilogy(mvecs, err_LowRank./trG, '-', 'Color', colors(3,:), 'LineWidth', 4);
...
subplot(2,3,6)
hold on
h1 = semilogy(mvecs, err_1S./trG, '-', 'Color', colors(1,:), 'LineWidth', 4);
h2 = semilogy(mvecs, BestErr_Fro./trG, 'o--', 'Color', colors(1,:), 'LineWidth', 4);
h3 = semilogy(mvecs, err_LowRank./trG, '-', 'Color', colors(3,:), 'LineWidth', 4);
h4 = semilogy(mvecs, BestErr_Tr./trG, 'o--', 'Color', colors(3,:), 'LineWidth', 4);
hold off
...
lgd = legend(ax_leg, [h1 h2 h3 h4], {'one-sample','bound one-sample','low-rank','bound low-rank'}, ...
